...
class VerificationRequest(BaseModel):
    ...
    context: str = Field(..., description="The consolidated text chunks used by the agent.")

    trace: str = Field(..., description="The computational trace (Python code + results) generated by the executor.")
...
class VerificationResponse(BaseModel):
    ...
    overall_groundedness_score: float = Field(..., description="Ratio of [GROUNDED] sentences to total sentences.")
